...
export default function Home() {
  ...
  const testimonials = [
    {
      quote: "a simplifié mon flux de travail et m'a permis d'obtenir des résultats réguliers.",
      name: "Jordan K.",
    },
    {
      quote: "Au départ, j'avais des doutes sur. Cependant, après quelques semaines d'utilisation, j'ai constaté une réelle différence dans mes résultats.",
      name: "Bailey T.",
    },
    {
      quote: "J'ai expérimenté de nombreux outils, mais sort du lot. Ses algorithmes sophistiqués et ses analyses rapides m'ont fait gagner beaucoup de temps",
      name: "Riley J.",
    },
    {
      quote: "Au départ, j'étais sceptique à propos de. Pourtant, après avoir commencé par un petit dépôt et favorisé une utilisation pendant plusieurs mois, je suis impressionné par sa précision et sa facilité d'utilisation.",
      name: "Elliot H.",
    },
    {
    ...
    {
      quote: "J'utilise pendant plus d'un an, je peux témoigner de son taux de réussite élevé. Il est indispensable à toute personne qui prend ce problème au sérieux",
      name: "Micah L.",
    },
    {
      quote: "m'a fait gagner beaucoup de temps et d'efforts lors de mes analyses. L'interface conviviale et les fonctions automatisées m'ont beaucoup facilité ma vie.",
      name: "Peyton M.",
    },
  ];
  const faqs = [
    {
      question: "Qu'est-ce que exactement ?",
      answer: "associe l'informatique quantique à l'intelligence artificielle. Il est conçu pour une analyse en temps réel et permettant des décisions plus intelligentes et plus rapides.",
    },
    {
      question: "Puis-je faire confiance à ?",
      answer: "a fait l'objet de tests approfondis et a démontré une réussite constante dans diverses conditions. Comme pour tout outil, il existe des risques et les utilisateurs doivent donc faire preuve de prudence.",
    },
    {
      question: "Quel est le coût de l'utilisation de ?",
      answer: "L'application est totalement gratuite pour l'ouverture d'un compte, mais pour utiliser pleinement de nos fonctions d'automatisation, nos algorithmes nécessitent un petit budget.",
    },
    {
      question: "Comment fonctionne ?",
      answer: "En s'appuyant sur des algorithmes sophistiqués, analyse les tendances, les nouvelles et les sentiments des médias sociaux. Sur la base de ces informations, il fournit des recommandations et travaille automatiquement sur votre compte.",
    },
    {
      question: "Comment commencer à utiliser ?",
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="pt-24 pb-24 relative overflow-hidden" style={{
        ...
        <div className="container mx-auto block max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 items-center justify-between p-6 md:p-12 gap-8">
            <div className="col-span-2 text-center md:text-left mb-8 md:mb-0 text-white">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">
                L'Avenir De <br /> L'Automatisation Par <br /> L'IA
              </h1>
              ...
              <div className="rounded-xl py-4 px-6 md:py-6 md:px-8 border border-white/10 bg-gray-900 inline-block">
                ...
                <div className="flex justify-center md:justify-start md:gap-8 gap-2">
            ...
            <div className="col-span-1 bg-white rounded-lg shadow-lg">
              <div className="text-gray-900 p-6">
                <h2 className="text-[22px] font-semibold mb-4 text-center">Inscrivez-Vous Maintenant</h2>
                <form>
                  <input
                    type="text"
                    placeholder="Prénom"
                    className="w-full px-3 py-3 mb-4 border rounded border-[#9ca3af] text-xs"
                  />
                  <input
                    type="text"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#3b82f6] text-white p-3 text-xs rounded hover:bg-blue-800"
                  >
        ...
        <div className="container mx-auto px-4 text-center max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-10 rounded-lg shadow-md shadow-black/5 hover:shadow-lg transition-shadow space-y-7 text-start">
                <img src={feature.icon} alt={feature.title} className="md:h-14 h:8" />
        ...
        <div className="mx-auto max-w-6xl md:px-6 lg:px-8">
          <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
            <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
              ...
              <h2 class="mb-10 md:mb-20 text-3xl md:text-4xl lg:text-5xl mx-auto font-bold max-w-3xl text-gray-900 text-center"> Assistance d'un expert 24 heures sur 24 </h2>
              <div class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 md:max-w-none text-left max-md:mx-auto">
                <ul className="text-left space-y-4 text-gray-600">
                  <li className="flex items-start">
                    <img src="https://bluepeaksfinance.com/wp-content/plugins/landing-page-template/assetes/images/lock-key-fill.svg" alt="" className="h-6 mr-2" />
                  ...
                  <li className="flex items-start">
                    <img src="https://bluepeaksfinance.com/wp-content/plugins/landing-page-template/assetes/images/translate-fill.svg" alt="" className="h-6 mr-2" />
      ...
      <div className="relative pt-20 md:pt-28 pb-24 md:pb-32 overflow-hidden bg-gradient-to-tr from-gray-900 to-gray-800 z-10" >
        <div className="max-w-6xl mx-auto px-6 text-center relative">
          ...
          <h2 className="mb-10 md:mb-20 text-3xl md:text-4xl lg:text-5xl mx-auto font-bold text-center max-w-3xl text-white">Fiable. Simple. Rapide.</h2>
          <div className="flex flex-wrap justify-center -m-3 lg:-m-5 text-left relative z-10">
            <div className="item w-full md:w-1/3 p-3 lg:p-5 max-w-sm">
              <div className="h-full p-8 lg:p-10 rounded-xl bg-white shadow text-center">
                ...
                <h3 className="mb-5 font-bold text-gray-900 text-xl md:text-2xl">Inscrivez-vous</h3>
                <p className="text-gray-600">Pour commencer, vous devez enregistrer votre compte après de. Une fois que vous l’aurez fait, vous aurez immédiatement accès au logiciel gratuitement.</p>
              </div>
            </div>
            <div className="item w-full md:w-1/3 p-3 lg:p-5 max-w-sm">
              <div className="h-full p-8 lg:p-10 rounded-xl bg-white shadow text-center">
                ...
                <h3 className="mb-5 font-bold text-gray-900 text-xl md:text-2xl">Alimenter votre compte</h3>
                <p className="text-gray-600">Vous aurez besoin de fonds pour permettre à de fonctionner correctement. Vous pouvez commencer modestement et augmenter les fonds au fur et à mesure de votre croissance.</p>
              </div>
            </div>
            <div className="item w-full md:w-1/3 p-3 lg:p-5 max-w-sm">
              <div className="h-full p-8 lg:p-10 rounded-xl bg-white shadow text-center">
                ...
                <h3 className="mb-5 font-bold text-gray-900 text-xl md:text-2xl">Utiliser</h3>
                <p className="text-gray-600">Commencez à profiter des avantages de notre algorithme prime. Le processus est totalement indépendant, bien que vous puissiez le dépasser en mode manuel si vous le souhaitez.</p>
              </div>
            </div>
          </div>
      ...
      <div className="pt-20 md:pt-28 pb-24 md:pb-32 overflow-hidden bg-gray-50 z-10">
        <div className="container max-w-7xl mx-auto px-6 text-center relative">
          ...
          <h2 className="mb-10 md:mb-20 text-3xl md:text-4xl lg:text-5xl mx-auto font-bold text-center max-w-3xl text-gray-900">Ce Que Les Gens Disent De</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {testimonials.map((testimonial, index) => (
              <div key={index} className={`bg-white p-6 rounded-lg space-y-4 text-start border border-gray-200 ${index == 1 ? "col-span-2 font-semibold" : "col-span-1"}`}>
      ...
      <div className="bg-white">
        <div className="container mx-auto max-w-7xl pb-24 px-6 sm:pb-32">
          <div className="relative isolate overflow-hidden bg-gradient-to-tr from-gray-900 to-gray-800 px-6 py-24 text-center shadow-2xl rounded-3xl sm:px-16">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300 font-weight-400">
              Découvrez la nouvelle génération d’outils d’automatisation avec. Ce mélange révolutionnaire d’intelligence artificielle et d’analyse complète des données offre des capacités extraordinaires, permettant aux utilisateurs de faire face à des conditions en constante évolution avec une précision et une sophistication inégalées.
            </p>
        ...
        <div className="container mx-auto max-w-7xl px-6 pb-24 md:pb-32">
          <div className="overflow-hidden rounded-lg" style={{ backgroundColor: 'rgb(241 245 249)' }}>
            <div className="p-8 md:p-10 lg:p-12">
              <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900">Vue d'ensemble</h3>
              <div className="mt-3 md:mt-4 text-gray-600 text-sm md:text-base">
                <p></p>
                <p>
                  est alimenté par une IA sophistiquée. Profitez d’une gestion de compte sans effort, et bénéficiez d’une compatibilité sur plusieurs appareils avec un accès mondial. Exploitez votre potentiel dès maintenant.
                </p>
                <p></p>
              </div>
            </div>
      ...
      <footer className="bg-[#F1F5F9] text-gray-500">
        <div className="container mx-auto px-4 text-center">
          <div class="text-center p-4 flex flex-wrap justify-between text-[15px] text-[#cccccc]">
            <p class="text-base mb-0">
              Copyright © 2021 Official Website. All Rights Reserved.
            </p>
            <ul class="md:flex text-base gap-6">
              <li class="">
